<template>
  <!--Must Add Other router links here-->
  <nav class="bg-green-800 h-20 items-center text-white flex justify-center space-x-4">
    <RouterLink :to="{name: 'Home'}">Home</RouterLink>
    <RouterLink :to="{name: 'Other'}">Tech.</RouterLink>
